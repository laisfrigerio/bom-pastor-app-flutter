...
abstract class IGoogleSheetApi {
...
class GoogleSheetApi implements IGoogleSheetApi {
  ...
  Future<void> addGoogleSheetData(
    ...
    try {
      ...
      if (result.updates?.updatedColumns != payload.length) {
        print(
          "Error: Could not add data to sheet. ${result.updates?.toJson()}",
        );
  ...
  Future<void> deleteGoogleSheetRow(
    ...
    try {
      ...
      final batchUpdateSpreadsheetRequest =
